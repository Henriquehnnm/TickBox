...
public class Application
{
    ...
    private void OnAboutAction()
    {
        ...
        about.ApplicationName = "Tickbox.UI";
        about.ApplicationIcon = "net.henriquehnnm.TickBox";
        about.DeveloperName = "Henrique Sardinha";
        about.Version = "0.1.0";
        about.Developers = ["Henrique Sardinha"];
        about.Copyright = "© 2026 Henrique Sardinha";
        about.Present();
    }
